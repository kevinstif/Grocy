...
export class InitialSchema1637983289898 implements MigrationInterface {
    name = 'InitialSchema1637983289898'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`customers\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`phone\` varchar(255) NOT NULL, \`address\` varchar(255) NOT NULL, \`first_name\` varchar(75) NULL, \`last_name\` varchar(75) NULL, \`amount\` decimal(10,2) NULL, \`currency\` varchar(10) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
